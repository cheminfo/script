...
public class ServletUtilities {
	...
	public static String getMimetype(String filename) {
		if (filename==null) return "text/text";
	...
	public static void returnResponse (HttpServletResponse response, String toReturn) {
		returnResponse(response, toReturn,"text/plain");
	}
	
	public static void returnResponse (HttpServletResponse response, String toReturn, String mimeType) {
		returnResponse(response, toReturn, mimeType, "");
	}
	
	public static void returnResponse (HttpServletResponse response, String toReturn, String mimeType, String filename) {
		try {
		...
		} catch (IOException e) {throw new RuntimeException("ServletUtilities: "+e.toString());}
	}
	
	public static OutputStream getOutputStream(HttpServletResponse response, String mimetype) {
		response.setContentType(mimetype);
		try {
	...
	public static void returnResult (HttpServletResponse response, Object value, HashMap<String,String> parameters) {
		try {
	...
	public static void returnStatus(HttpServletResponse response, String status, Object value) {
		try {
			JSONObject json=new JSONObject();
